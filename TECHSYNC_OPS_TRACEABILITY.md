...
| 4 | External Interfaces | Partially proven: CSV import, webhook intake, attachment storage boundary, Stripe/email boundaries. | Printable closeout export and dashboard CSV exports begin in v1.3; SMS/push, calendar/maps, accounting/export, binary PDFs, and deeper storage workflows expand later. |
...
7. Reporting for stale work, overloaded technicians, property hotspots, and
   completion cycle time, with the first mobile report view and dashboard CSV
   exports now started.
