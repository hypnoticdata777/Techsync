...
| 7 | Nonfunctional Requirements | Partially proven: app-layer tenant isolation, RLS policies, audit trail, structured logs, hosted-demo config. | Local/demo backup/restore/export/monitoring runbook is now started; performance targets, retry/offline resilience, provider backup evidence, monitoring, and accessibility evidence remain v1.2/v1.3 operational work. |
