...
| 4 | External Interfaces | Partially proven: CSV import, webhook intake, attachment storage boundary, Stripe/email boundaries. | HTML/text/PDF closeout export, dashboard CSV exports, client/property/vendor CSV exports, and admin tenant JSON export are now started in v1.3; SMS/push, calendar/maps, accounting/export, and binary storage export workflows expand later. |
...
9. v1.3 hosted smoke evidence for PMC entity links, communication visibility,
   ...
   exports, plus tenant JSON export.
